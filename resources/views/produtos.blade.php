...
<script type="text/javascript">
    ...
    function carregarCategorias() {
        $.getJSON("{{ url('/api/categorias') }}", function(data) { 
            opcao = '<option value="">Selecione</option>';
    ...
    function editar(id) {
        $.getJSON("{{ url('/api/produtos/')}}/"+id, function(data) { 
            console.log(data);
            $('#id').val(data.id);
    ...
    function carregarProdutos() {
        $.getJSON("{{ url('/api/produtos') }}", function(produtos) { 
    ...
    function criarProduto() {
        ...
        $.post("{{ url('/api/produtos' )}}", prod, function(data) {
